...
class Cell:
    ...
    def __add__(self, other):
        return f'cell addition: {self.quantity + other.quantity}'

    def __sub__(self, other):
        sub = self.quantity - other.quantity
        return f'cell subtraction: {sub}' if sub > 0 else 'cell annigilated :('

    def __truediv__(self, other):
        return f'cell division: {self.quantity // other.quantity}'

    def __mul__(self, other):
        return f'cell multiplication: {self.quantity * other.quantity}'
